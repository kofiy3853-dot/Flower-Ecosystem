...
app.get('/my-garden-hub', (_, res) => res.sendFile(path.join(__dirname, 'my-garden-hub.html')));
...
app.get('/category-listing', (_, res) => res.sendFile(path.join(__dirname, 'category-listing.html')));
app.get('/services', (_, res) => res.sendFile(path.join(__dirname, 'services.html')));
app.get('/feed', (_, res) => res.sendFile(path.join(__dirname, 'feed.html')));
app.get('/my-learning', (_, res) => res.sendFile(path.join(__dirname, 'my-learning.html')));
app.get('/deals', (_, res) => res.sendFile(path.join(__dirname, 'deals.html')));
app.get('/collection', (_, res) => res.sendFile(path.join(__dirname, 'collection.html')));
...
app.use((err, _req, res, _next) => {
    ...
    console.error(`[${_req.method} ${_req.url}] ${status}: ${err.message}`);
